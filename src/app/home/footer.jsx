            ...
            <div className="flex items-center gap-3 md:gap-3.5">
              ...
              >
                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path className="stroke-white group-hover:stroke-blue transition-colors" d="M4 7.00005L10.2 11.65C11.2667 12.45 12.7333 12.45 13.8 11.65L20 7" stroke="#FFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <rect className="stroke-white group-hover:stroke-blue transition-colors" x="3" y="5" width="18" height="14" rx="2" stroke="#FFF" strokeWidth="2" strokeLinecap="round"/>
                </svg>
              </a>
            </div>
          </div>
