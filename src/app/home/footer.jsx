    ...
    <footer className="bg-[#090909] pt-6 xl:pt-12 2xl:pt-10 3xl:pt-[60px] pb-8 xl:pb-[44px] 3xl:pb-[54px] overflow-hidden">
      ...
      <SiteContainer>
        <div className="flex items-center justify-between flex-col md:flex-row">
          ...
          <div className="flex items-center gap-6 md:gap-12 mt-10 md:mt-0 flex-col md:flex-row">
            ...
            <div className="flex items-center gap-3 md:gap-3.5">
              <button 
                className="border border-white-20 rounded-md h-9 w-9 group flex items-center justify-center hover:border-blue transition-colors"
